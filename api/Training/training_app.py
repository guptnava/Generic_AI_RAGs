...
from utils.oracle_utils import (
    ...
    insert_synonyms, insert_embeddings, search_embeddings,
...
@st.cache_resource
def load_model():
    return SentenceTransformer("/Users/naveengupta/veda-chatbot/api/local_all-MiniLM-L6-v2")
...
st.title("🧠 NLP → SQL Training Dashboard (Oracle Native)")

tab1, tab2, tab3, tab4 = st.tabs(["1. Extract Schema", "2. Generate Questions", "3. Build Embeddings", "4. Evaluation"])
...
with tab4:
    ...
    if st.button("Evaluate Prompt"):
        ...
        if not conn:
            ...
            results = search_embeddings(conn, q_emb, top_k=k)
